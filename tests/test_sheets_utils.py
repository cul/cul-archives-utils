...
from cul_archives_utils.sheets_utils import GoogleSheetsClient
from tests.helpers import mock_build_service, mock_get_sheet_info


class TestGoogleSheetsClient(unittest.TestCase):
    @patch("cul_archives_utils.sheets_utils.build")
    ...
    @patch("cul_archives_utils.sheets_utils.GoogleSheetsClient.get_sheet_info")
